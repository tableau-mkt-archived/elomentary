...
/**
 * @file
 * Contains \Eloqua\Tests\Api\Assets\Email\FolderTest.
 */
...
class FolderTest extends TestCase {
  ...
  public function shouldSearchFoldersWithOptions() {
    ...
    $api->expects($this->once())
      ->method('get')
      ->with('assets/email/folders', array_merge(array('search' => $folder_name), $options))
      ->will($this->returnValue($expected_response));
  ...
  public function shouldShowFolderJustId() {
    ...
    $api->expects($this->once())
      ->method('get')
      ->with('assets/email/folder/' . $folder_id, array(
        'depth' => 'complete',
        'extensions' => null,
      ))
      ->will($this->returnValue($expected_response));
  ...
  public function shouldUpdateFolder() {
    ...
    $api->expects($this->once())
      ->method('put')
      ->with('assets/email/folder/' . $folder_id, $folder_data)
  ...
  public function shouldDeleteFolder() {
    ...
    $api->expects($this->once())
      ->method('delete')
      ->with('assets/email/folder/' . $folder_id)
      ->will($this->returnValue($expected_response));
  ...
  public function shouldCreateFolder() {
    ...
    $api->expects($this->once())
      ->method('post')
      ->with('assets/email/folder', $folder_data)
      ->will($this->returnValue($folder_data));
  ...
  public function shouldGetFolderContents() {
    ...
    $api->expects($this->once())
      ->method('get')
      ->with('assets/email/folder/' . $folder_id . '/contents')
      ->will($this->returnValue($expected_response));
  ...
  public function shouldGetFolderDependencies() {
    ...
    $api->expects($this->once())
      ->method('get')
      ->with('assets/email/folder/' . $folder_id . '/dependencies')
      ->will($this->returnValue($expected_response));
  ...
  public function shouldGetFolderRoot() {
    ...
    $api->expects($this->once())
      ->method('get')
      ->with('assets/email/folder/root', array(
        'depth' => 'complete',
        'extensions' => null,
      ))
      ->will($this->returnValue($expected_response));
